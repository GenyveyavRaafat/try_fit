...
class BoundedGridLocNet(nn.Module):
    ...
    def forward(self, x):
        ...
        l2_loss = torch.norm(points, p=2) * 0.1  # New L2 penalty
        ...
        # my update here
        rx, ry, cx, cy = torch.tensor(0.05).cuda(), torch.tensor(0.05).cuda() \
            , torch.tensor(0.05).cuda(), torch.tensor(0.05).cuda()
        # //////////
        ...
        return coor, rx_loss + l2_loss, ry_loss + l2_loss, cx_loss + l2_loss, cy_loss + l2_loss, rg_loss, cg_loss
